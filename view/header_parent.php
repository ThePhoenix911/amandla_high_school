...
<main>
    <div id="nav">
        <a class="nav_item <?php if(in_array($action?? '', ['parent_home', 'parent_login', 'view_students'])) echo 'active_tab';?>" href="?action=view_students">View Students</a>
        <a class="nav_item <?php if(in_array($action?? '', ['register_student_form', 'book_student_form', 'link_student']))
            echo 'active_tab';?>" href="?action=register_student_form">Register Student
        </a>
    </div>
